...
CREATE TABLE `adminlogins` (
  `adminsname` varchar(45) NOT NULL,
  `adminspassword` int(50) NOT NULL,
  `adminsid` int(50) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `adminlogins` VALUES ('Mykyta Bieliaiev',161329,1);
