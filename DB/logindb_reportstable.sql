...
CREATE TABLE `reportstable` (
  `reportsid` int(100) NOT NULL AUTO_INCREMENT,
  `reportsmessage` varchar(200) NOT NULL,
  `userscretedid` int(45) NOT NULL,
...
LOCK TABLES `reportstable` WRITE;
/*!40000 ALTER TABLE `reportstable` DISABLE KEYS */;
/*!40000 ALTER TABLE `reportstable` ENABLE KEYS */;
UNLOCK TABLES;
